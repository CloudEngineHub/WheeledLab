...
class BEVMap:
    ...
    def get_map_val_center(self):
        '''
        Get the center value of the map in the world frame.
        This is useful for debugging and visualization.
        '''
        center_i = self.map_length_px // 2
        center_j = self.map_length_px // 2
        return self.get_map_ij(center_i, center_j)